...
RUN_DESCRIPTION = "Using self-learned ssm embeddings + dropout + batch_norm + aggressive dropout usage"
...
class SimpleModel(eqx.Module):
    ...
    def __init__(
        ...
        self.mlp = eqx.nn.MLP(d_model, d_model, width_size=d_model, depth=3, key=k1)
